"""
Django settings for FootlooseAfdansenApp project.
...
WSGI_APPLICATION = 'FootlooseAfdansenApp.wsgi.application'
...
CACHES = {
    "default": {
        ...
        "TIMEOUT":None,
        "KEY_PREFIX":"FootlooseAfdansenAppdev",
    }
}
...
STATIC_URL = '/static/'
STATIC_ROOT = '/root/FootlooseAfdansenApp/templates/static/'
